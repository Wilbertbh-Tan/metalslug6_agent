...
print(f"{'Raw bytes':<20} {'LE16':<10} {'LE32':<10} {'BE16':<10} {'BE32':<10} {'BCD':<10}")
print("-" * 70)
...
for i in range(30):
    ...
    if b:
        ...
        print(f"{raw:<20} {decode_le16(b):<10} {decode_le32(b):<10} {decode_be16(b):<10} {decode_be32(b):<10} {decode_bcd(b):<10}")
    time.sleep(1)
